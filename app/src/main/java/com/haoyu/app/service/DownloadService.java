...
public class DownloadService extends Service {
    ...
    private void download(String url, final String downloadPath, final String fileName) {
    ...
    private void notification() {
        builder =
                new NotificationCompat.Builder(this).setSmallIcon(R.drawable.gdei_logo_s);
        remoteViews = new RemoteViews(getPackageName(), R.layout.notification_layout);
        remoteViews.setImageViewResource(R.id.iv_icon, R.drawable.gdei_logo_s);
