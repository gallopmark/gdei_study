...
public class PageMyQuestionFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    public void initData() {
        String url = Constants.OUTRT_NET + "/m/faq_question" + "?relation.id=" + relationId + "&relation.type" + relationType + "&page=" + page + "&orders=CREATE_TIME.DESC" + "&creator.id=" + getUserId() + "&isLoadNewstAnswer=true";
