...
/**
 * 创建日期：2017/10/24 on 15:38
 * 描述:
 * 作者:马飞奔 Administrator
 */
public class TeachStudyMyCCFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    public void initData() {
        String url = Constants.OUTRT_NET + "/m/lesson/cmts?discussionRelations[0].relation.id=cmts"
                + "&discussionRelations[0].relation.type=lesson&creator.id=" + getUserId() + "&page=" + page + "&orders=CREATE_TIME.DESC";
