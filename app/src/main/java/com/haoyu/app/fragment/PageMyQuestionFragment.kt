 ...
 * 作者:xiaoma
 */
class PageMyQuestionFragment : BaseFragment(), XRecyclerView.LoadingListener {
    ...
    override fun initView(view: View) {
        ...
        tvEmpty.text = resources.getString(R.string.empty_ask)
        registRxBus()
    }

    override fun initData() {
        val url = Constants.OUTRT_NET + "/m/faq_question" + "?relation.id=" + relationId + "&relation.type" + relationType + "&page=" + page + "&orders=CREATE_TIME.DESC" + "&creator.id=" + userId + "&isLoadNewstAnswer=true"
