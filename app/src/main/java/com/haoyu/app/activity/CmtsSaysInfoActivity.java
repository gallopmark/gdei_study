 ...
 */
public class CmtsSaysInfoActivity extends BaseActivity implements View.OnClickListener {
    private CmtsSaysInfoActivity context;
    ...
    public void initData() {
        ...
        addSubscription(OkHttpClientManager.getAsyn(context, url, new OkHttpClientManager.ResultCallback<DiscussResult>() {
            ...
            @Override
            public void onResponse(DiscussResult result) {
                loadingView.setVisibility(View.GONE);
            ...
            public ReplyListResult apply(ReplyListResult result) throws Exception {
                ...
                .subscribe(new Consumer<ReplyListResult>() {
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        lfv.setVisibility(View.VISIBLE);
                    }
                }));
    }
    ...
    private void updateUI(List<ReplyEntity> mainList, Paginator paginator) {
        ...
        if (mainList.size() > 0) {
            ...
            if (paginator != null) {
                ...
                replyNum = paginator.getTotalCount();
            }
    ...
    private void setReply_text(int replyNum) {
