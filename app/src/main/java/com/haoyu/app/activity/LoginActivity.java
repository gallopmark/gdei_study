...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void setListener() {
        ...
        cb_remember.setOnCheckedChangeListener(new CheckBox.OnCheckedChangeListener() {
            ...
            public LoginResult apply(String url) throws Exception {
                ...
                .subscribe(new Consumer<LoginResult>() {
                    ...
                    public void accept(LoginResult result) throws Exception {
                        ...
                        if (result != null && result.getResponseData() != null && result.getResponseData().getRole() != null && result.getResponseData().getRole().contains(student)) {
