...
public class VideoPlayerActivity extends BaseActivity implements View.OnClickListener/*, OnFileDownloadStatusListener */ {
    ...
    public int setLayoutResID() {
        return R.layout.activity_videoplayer_test;
    }
    ...
    private void showPopWindow() {
        ...
        View parentView = LayoutInflater.from(this).inflate(R.layout.activity_videoplayer_test, null);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        int width = MyUtils.getWidth(this);
        int height = MyUtils.getHeight(this);
        params.width = width;
    ...
    public int setVideoProgress(int currentProgress) {
        ...
        //更新播放时间
        if (mVideoView.getCurrentPosition() / 1000 > 0 && mVideoView.getCurrentPosition() / 1000 % 30 == 0 && mVideoView.isPlaying()) {
